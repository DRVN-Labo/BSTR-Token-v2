...
contract BSTRToken is ERC20Permit, ERC20Votes, TaxableToken, Ownable {
    ...
    */
    ...
    function updateFeeCollectorShare(address account, uint256 share) external override onlyOwner nonReentrant {
     ...
     /**
     * [Audit Note - TaxableToken Integration]
     * Overrides required by TaxableToken to handle fee distribution. We had to remove the nonReentrant modifier because it was 
        causing issues with the fee distribution for the processFees function on line number 174.
     */
